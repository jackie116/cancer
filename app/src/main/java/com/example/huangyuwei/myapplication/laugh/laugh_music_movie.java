...
public class laugh_music_movie extends AppCompatActivity {
    ...
    private laugh_music_movie.myWebChromeClient xwebchromeclient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laugh_music_movie);

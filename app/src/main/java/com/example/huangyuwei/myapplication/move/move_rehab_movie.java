...
public class move_rehab_movie extends AppCompatActivity {
    private WebView mWebView;
    private FrameLayout video_fullView;// 全屏时视频加载view
    private View xCustomView;
    private ProgressDialog waitdialog = null;
    private WebChromeClient.CustomViewCallback xCustomViewCallback;
    private move_rehab_movie.myWebChromeClient xwebchromeclient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_move_rehab_movie);
        ...
        xwebchromeclient = new move_rehab_movie.myWebChromeClient();
        mWebView.setWebChromeClient(xwebchromeclient);

        // 設定轉址的網頁還是由WebView開啟，不要用外部的瀏覽器。
        mWebView.setWebViewClient(new WebViewClient());

        mWebView.loadUrl("https://youtu.be/epJQWLwLfaI?list=PL8XfZflYfwK2eOhs9tpjxr5Pn9r-RyrYp");
    }

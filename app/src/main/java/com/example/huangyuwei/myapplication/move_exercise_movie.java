...
public class move_exercise_movie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_move_exercise_movie);
        ...
        mWebView.loadUrl("https://youtu.be/7jFdNhpZuaE?list=PL8XfZflYfwK0iRV4iDGBAN37maJMMbBET");

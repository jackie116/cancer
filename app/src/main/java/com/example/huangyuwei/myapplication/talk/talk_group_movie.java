...
public class talk_group_movie extends AppCompatActivity {
    ...
    private talk_group_movie.myWebChromeClient xwebchromeclient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_talk_group_movie);
        ...
        mWebView.loadUrl("https://youtu.be/uxRz5ublQNY?list=PL8XfZflYfwK3cywhda1_HmQ_3tW6OTS-j");

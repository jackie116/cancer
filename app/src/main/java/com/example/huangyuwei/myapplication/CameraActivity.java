...
public class CameraActivity extends Activity {
    ...
    public static File fileIn = new File(ImgRecordpath + "/" + appPath + "/" + "ImgRecord.txt");
    ...
    protected void takePicture() {
        ...
        try {
            ...
            File f = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath() + "/Cancer/");

            if(!f.exists())
                f.mkdir();
            final File file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath() + "/Cancer/" + timeStamp + ".jpg");
